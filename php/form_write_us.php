...
if (!empty($_POST)){
   ...
   $fname_write_us = htmlspecialchars($_POST["fname_write_us"]);       
   $email_write_us = htmlspecialchars($_POST["email_write_us"]); 
   $msg_write_us = htmlspecialchars($_POST["msg_write_us"]);
   //$picture = "";     
  ...
  $body .= "ИМЯ:".$fname_write_us."\r\n";    
  $body .= "EMAIL:".$email_write_us."\r\n";
  $body .= "СООБЩЕНИЕ:".$msg_write_us."\r\n";
...
{
  $subject = '=?utf-8?B?'.base64_encode('Заявка на возникшие вопросы').'?=';
  $boundary = "--".md5(uniqid(time())); // генерируем разделитель
  
  $headers = "From:".htmlspecialchars($_POST["fname_write_us"])." <".htmlspecialchars($_POST["email_write_us"]).">\r\n"; 
