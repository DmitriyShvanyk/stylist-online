...
if (!empty($_POST)){
   ...
   $fname_ask = htmlspecialchars($_POST["fname_ask"]);       
   $email_ask = htmlspecialchars($_POST["email_ask"]); 
   $msg_ask = htmlspecialchars($_POST["msg_ask"]);
   //$picture = "";     
  ...
  $body .= "ИМЯ:".$fname_ask."\r\n";    
  $body .= "EMAIL:".$email_ask."\r\n";
  $body .= "СООБЩЕНИЕ:".$msg_ask."\r\n";
...
function send_mail($admin, $body, $email, $filepath, $filename)
{
  ...
  $headers = "From:".htmlspecialchars($_POST["fname_ask"])." <".htmlspecialchars($_POST["email_ask"]).">\r\n"; 
