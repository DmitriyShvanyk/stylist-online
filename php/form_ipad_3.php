...
if (!empty($_POST)){
   ...
   $fname_ipad_3 = htmlspecialchars($_POST["fname_ipad_3"]);       
   $email_ipad_3 = htmlspecialchars($_POST["email_ipad_3"]); 
   $radio_ipad_3 = htmlspecialchars($_POST["radio_ipad_3"]);
   //$picture = "";     
  ...
  $body .= "ИМЯ:".$fname_ipad_3."\r\n";    
  $body .= "EMAIL:".$email_ipad_3."\r\n";
  $body .= "КУРС:".$radio_ipad_3."\r\n";
...
function send_mail($admin, $body, $email, $filepath, $filename)
{
  ...
  $headers = "From:".htmlspecialchars($_POST["fname_ipad_3"])." <".htmlspecialchars($_POST["email_ipad_3"]).">\r\n"; 
